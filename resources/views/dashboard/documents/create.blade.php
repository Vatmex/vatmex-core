                ...
                <div class="card">
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            ...
                            <form action="{{ route('dashboard.documents.store') }}" method="post" class="form form-horizontal" enctype="multipart/form-data">
                                @csrf
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 mx-auto">
                                            <input type="text" id="version" class="form-control" placeholder="Version del Documento" name="version">
                                        </div>
                                    </div>
